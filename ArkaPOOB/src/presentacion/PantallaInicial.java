...
/**
 * Representa la pantalla inicial, donde se selecciona toda la configuraci�n del
 * juego
 * 
...
public class PantallaInicial extends JPanel {
	...
	protected JButton player1, player2, playerCPU, atras, imagencontrol, curioso, mimo, destructor, abrir, controles,
			salir, nivel1, nivel2, nivel3, nivel4, nivel5;
	private boolean niveles, elementos;
	protected int numJugadores;

	// Para pantalla de seleccionar elementos:
	protected JCheckBox azul, amarillo, anaranjado, gris, negro, rojo, rosado, verde, sBMas, sBMenos, sPlatMas,
			sPlatMenos, sEspecial, sPegajosa;
