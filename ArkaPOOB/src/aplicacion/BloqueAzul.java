...
/**
 * Estos bloques lanzan de manera aleatoria los �sorpresas�. Tambi�n son poco
 * comunes. Dan 300 puntos.
 * 
...
public class BloqueAzul extends Bloque {
	...
	private static String[] seleccion = { "DisminuirPlataforma", "AumentarPlataforma", "SorpresaPlataformaEspecial",
			"SorpresaPlataformaPegajosa", "AumentarVelocidadBola", "DisminuirVelocidadBola" };
