...
public abstract class Jugador implements Serializable {
	...
	/**
	 * Da el tipo de maquina que es segun corresponda: 0 si es curioso, 1 si es
	 * destructor o 2 si es mimo.
	 * 
	 * @return
	 */
	...
	/**
	 * Determina el movimiento del jugador dependiendo de la bola, sorpresas y otro
	 * jugador segun corresponda
	 * 
	 * @param bola        bola actual del juego
	 * @param sorpresas   sorpresas en juego
	 * @param otroJugador en juego
	 */
	public abstract void mover(Bola bola, ArrayList<Sorpresa> sorpresas, Jugador otroJugador);
	...
	/**
	 * Le da el indice para el color del jugador: 0 si es rojo, 1 narajana, 2
	 * morado, 3 rosado, 4 verde
	 * 
	...
	public boolean tocado(double xBola, double yBola, double dx, double dy) {
		return ((yBola < getY() - 20 && yBola + dy >= getY() - 20)
				&& ((xBola + 20 >= getX() && xBola + 20 <= getX() + plataforma.getAncho())
						|| (xBola >= getX() && xBola <= getX() + plataforma.getAncho()))
				&& isVisible());
	}

	/**
	 * Indica el nuevo angulo que va a tener la bola cuando �sta toca la plataforma
	 * 
	...
	/**
	 * Cuando la bola rebota en el jugador se va quitando el poder. Un poder alcanza
	 * 3 rebotes.
	 */
	...
	/**
	 * Suelta la bola cuando tiene le poder pegajoso o cuando inicia en el modo de
	 * un jugador
	 */
