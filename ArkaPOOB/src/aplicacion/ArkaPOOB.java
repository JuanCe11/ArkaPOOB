...
public class ArkaPOOB implements Serializable {
	...
	/**
	 * Selecciona el nivel actual, crea la nueva bola y crea la configuracion de
	 * bloques
	 * 
	 * @param nivel actual
	 */
	...
	/**
	 * Crea los jugadores dependiendo de la cantidad y el tipo de jugador (humano o
	 * maquina)
	 * 
	 * @param NJugadores número de jugadores
	 * @param maquina    número de maquinas 0 si no hay maquina, 1 si es destructor,
	 *                   2 si es curioso y 3 si es mimo
	 */
	...
	public void atenderBloques(int[] opciones) {
		if (opciones[2] == -4) {
			añadirVida(opciones[1]);// bloque amarillo
		}
	}
	 ...
	 */
	public void añadirVida(int jugador) {
		sonidoVida();
		jugadores[jugador].añadirVida();
	}

	/**
	 * Coloca la bola en el tablero dependiendo del numero de jugadores: En el
	 * centro de la plataforma o arriba
	 * 
	...
	/**
	 * Dice si el nivel actual se acabo, un nivel se acaba cuando todos sus bloques
	 * estan fuera de juego. Ademas si acaba un nivel reinicia al estado actual del
	 * siguiente nivel.
	 * 
	...
	/**
	 * Dice si el juego acabo. Un juego acaba cuando uno de sus jugadores se queda
	 * sin vidas.
	 * 
	 ...
	 * @throws ArkaPOOBException cuando no hay bloques o solo se juega con bloques
	 *                           grises/negros
	 */
	...
	/**
	 * Convierte el formato en el que vienen los elementos seleccionados (mappeo
	 * segun posicion: 1 si esta, o 0 si no esta el elemento) a una lista de los
	 * números de los elementos con los que se va a jugar
	 * 
