...
public abstract class Bloque extends Elemento {
	...
	public char tocar(Bola bola, ArkaPOOB juego) {
		...
		if ((xBola < getX() - 20 && xBola + dx >= getX() - 20) && ((yBola + 20 >= getY() && yBola + 20 <= getY() + 17)
				...
				&& isVisible()) {
			respuesta = 'x';
		} else if ((xBola > getX() + 66 && xBola + dx <= getX() + 66)
				&& ((yBola + 20 >= getY() && yBola + 20 <= getY() + 17) || (yBola >= getY() && yBola <= getY() + 17)
						|| (yBola <= getY() && yBola + 20 >= getY() + 17))
				&& isVisible()) {
			respuesta = 'x';
		} else if ((yBola < getY() - 20 && yBola + dy >= getY() - 20)
				&& ((xBola + 20 >= getX() && xBola + 20 <= getX() + 66) || (xBola >= getX() && xBola <= getX() + 66))
				&& isVisible()) {
			respuesta = 'y';
		} else if ((yBola > getY() + 17 && yBola + dy <= getY() + 17)
				&& ((xBola + 20 >= getX() && xBola + 20 <= getX() + 66) || (xBola >= getX() && xBola <= getX() + 66))
				&& isVisible()) {
			respuesta = 'y';
		}
